...
//
//  Created by Shiwangi Shah on 27/11/13.
//  All rights reserved.
//
...
{
    kMax=1000;
    img=cv::Mat(cvSize(800, 800),CV_8UC3,cvScalarAll(0));
...
void Clothoid::getTrajectory()
{
    ...
    double k1=sigma*larc/2+k0;double theta1=sigma/2*larc*larc/4+k0*larc/2+theta0;
